...
def create_table_and_insert(name, room_type, check_in_date, check_out_date):
...
def addrec():
    if request.method == 'POST':
        ...
        create_table_and_insert(name, room_type, check_in_date, check_out_date)
        return redirect(url_for('confirmation'))  # redirect to the confirmation page
